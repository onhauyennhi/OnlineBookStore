<?php 
    ...
    if(isset($_POST['addCategory'])){
        ...
        if(empty($err)){
            $cate=mysqli_query($con,"insert into category(categoryName) values('$categoryName')");
    ...
    $delete_cate=mysqli_query($con,"delete from category where categoryID='$id'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="flex">
            ...
            <li><a href="admin_category.php">Danh mục</a></li>
                ...
                <form action="" method="POST">
                    <input class="add-category" type="text" placeholder="Nhập tên danh mục..." name="categoryName">
                    <button onclick="return confirm('Bạn muốn thêm danh mục này?');" type="submit" name="addCategory" class="btn btn-success" style="margin-bottom: 15px;">Thêm Danh Mục</button>                </form>
