<?php 
    ...
    if($delete_customer){
        $select_bill=mysqli_query($con,"select * from bill where customerID='$id'");
        $bill=mysqli_fetch_array($select_bill);
        $delete_bill=mysqli_query($con, "delete from bill where customerID='$id'");
        if(isset($bill)){
            $delete_billdetails=mysqli_query($con,"delete from billdetails where billID='$bill[billID]'");
        }
    }
?>
<!DOCTYPE html>
...
<div class="flex">
    ...
    <div class="content-customer">
                ...
                <form action="admin_customer.php?quanly=timkiem" class="search-customer-bar" method="POST">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql="SELECT * FROM customer ORDER BY customerID ASC LIMIT ".$item_page." offset " .$offset ;
                            $sql_pd=mysqli_query($con,"select * from customer");
                            ...
                            $i=0; 
                            $customer_query=mysqli_query($con,"select * from customer");
