<?php
    ...
    $sql_pro="SELECT * FROM product WHERE categoryID='6' AND productName LIKE '%$tukhoa%' LIMIT ".$item_page." offset " .$offset;
    $sql_pd=mysqli_query($con,"select * from product where categoryID='6' AND productName Like '%$tukhoa%'");
